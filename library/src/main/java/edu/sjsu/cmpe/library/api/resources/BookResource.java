...
if(status.toString()=="lost")
{
	...
	System.out.println("port"+configuration.getApolloPort());
	...
	String destination = configuration.getStompQueueName();
	Destination dest = new StompJmsDestination(destination);
	MessageProducer producer = session.createProducer(dest);
	producer.setDeliveryMode(DeliveryMode.NON_PERSISTENT);
	String data=configuration.getLibraryName()+":"+isbn;
	System.out.println("message sent to queue is: "+data);
